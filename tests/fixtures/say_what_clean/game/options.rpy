...
define config.name = _("RenForge Demo")

## Quit without the confirmation prompt so automated runs (e.g. the RenForge
## bridge launcher terminating the process) exit cleanly.
